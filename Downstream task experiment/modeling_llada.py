...
class LLaDABlock(nn.Module):
    ...
    def _scaled_dot_product_attention(
        ...
        if self.flash_attn_func is not None and attn_mask is None:
            ...
            exact_scores = exact_scores - exact_scores.max(dim=-1, keepdim=True).values
            ...
            approx = torch.clamp(approx, min=1e-8)
            ...
            # exact_scores = torch.exp(exact_scores)
            # attn = exact_scores / exact_scores.sum(dim=-1, keepdim=True)
